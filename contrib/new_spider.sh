...
echo "git fetch upstream && git checkout upstream/master && git checkout -b $1 && pipenv run scrapy genspider $1 $1 && git add locations/spiders/$1.py && code locations/spiders/$1.py"
