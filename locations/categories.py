...
class PaymentMethods(Enum):
    ...
    ICSF = "payment:icsf"
    ID = "payment:id"
    J_COIN_PAY = "payment:j_coin_pay"
    JCB = "payment:jcb"
    KAKAO_PAY = "payment:kakaopay"
    KITACA = "payment:kitaca"
