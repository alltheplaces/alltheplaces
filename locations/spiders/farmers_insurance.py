...
class FarmersInsuranceSpider(scrapy.Spider):
    ...
    chain_name = "Farmers Insurance"
    allowed_domains = ["agents.farmers.com"]
    start_urls = (
        'https://agents.farmers.com/',
    )
    ...
    def parse_location(self, response):
        ...
        hours_data = self.parse_hours(response.xpath('//div[@class="c-location-hours-details-wrapper js-location-hours"]/@data-days').extract_first())
