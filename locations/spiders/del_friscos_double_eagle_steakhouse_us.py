...
class DelFriscosDoubleEagleSteakhouseUSSpider(JSONBlobSpider):
    name = "del_friscos_double_eagle_steakhouse_us"
    item_attributes = {"brand": "Del Frisco's Double Eagle Steakhouse", "brand_wikidata": "Q23461481"}
    start_urls = ["https://www.delfriscos.com/store-locator/"]
    ...
    def post_process_item(self, item: Feature, response, location: dict):
        item["name"] = "Del Frisco's Double Eagle Steakhouse"
