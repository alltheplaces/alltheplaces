...
class MercySpider(scrapy.Spider):
    ...
    categories = [
        ...
        ("Cancer Treatment Center", {"healthcare": "centre", "healthcare:specialty": "cancer_treatment_centre"}),
        ("Hearing and Vision", {"healthcare": "centre", "healthcare:specialty": "optometrist;audiologist"}),
        ...
        ("Gastroenterology Center", {"healthcare": "centre", "healthcare:specialty": "gastroenterology"}),
