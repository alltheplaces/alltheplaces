...
class KfcZASpider(scrapy.Spider):
    name = "kfc_za"
    item_attributes = KFC_SHARED_ATTRIBUTES
    start_urls = ["https://orderserv-kfc-eu-olo-api.yum.com/dev/v1/stores/"]
    ...
    def parse(self, response):
        for location in response.json():
            ...
            item["website"] = "https://order.kfc.com.za/restaurants/" + web_path
