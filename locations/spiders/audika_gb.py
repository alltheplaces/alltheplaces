...
class AudikaSpider(CrawlSpider):
    ...
    start_urls = [
        "https://www.audika.co.uk/hearing-aids-centre/all-clinics"
    ]
    ...
    def parse(self, response: Response, **kwargs: Any) -> Any:
        ...
        item["name"] = 'Audika'
        centerid = re.search(r'([0-9]+)$',response.xpath("//a[starts-with(@href,'/book-appointment/online-booking?centerid=')]/@href").get())
        if centerid:
