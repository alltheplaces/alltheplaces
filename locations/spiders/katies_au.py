...
class KatiesAUSpider(SitemapSpider):
    name = "katies_au"
    item_attributes = {"brand": "Katies", "brand_wikidata": "Q120646115"}
    allowed_domains = ["www.katies.com.au"]
    sitemap_urls = ["https://www.katies.com.au/Store.xml"]
