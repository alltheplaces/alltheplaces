...
class TheNorthFaceSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        current_state = json.dumps(
            {"request": {"appkey": "C1907EFA-14E9-11DF-8215-BBFCBD236D0E",
                         "formdata": {"geoip": "false", "dataview": "store_default", "limit": 1000,
                                      "order": "rank, _DISTANCE", "geolocs": {"geoloc": [
                                 {"addressline": "Austin TX 78754", "country": "US", "latitude": "", "longitude": ""}]},
                                      "searchradius": "5000", "where": {"visiblelocations": {"eq": ""},
                                                                        "or": {"northface": {"eq": "1"},
                                                                               "outletstore": {"eq": "1"},
                                                                               "retailstore": {"eq": ""},
                                                                               "summit": {"eq": ""}},
