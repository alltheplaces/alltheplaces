...
class SsangyongAUSpider(Spider):
    ...
    def parse(self, response: Response) -> Iterable[Feature]:
        for dealer in response.xpath('//div[@id="dealer-columns-section"]/div'):
            ...
            hours_text = "Monday-Friday: {}, Saturday: {}, Sunday: {}".format(dealer.xpath('.//@dealeropenmonfri').get(""), dealer.xpath('.//@dealeropensaturday').get(""), dealer.xpath('.//@dealeropensunday').get(""))
