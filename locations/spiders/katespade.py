        ...
        if stores:
            ...
            for store in stores:
                ...
                properties = {
                    ...
                    'addr_full': " ".join([store["attributes"]["address1"], store.get("address2", ""), store.get("address3", "")]).strip(),
                ...
                url = response.urljoin(
                    response.url.replace("page%22:{}".format(page), "page%22:{}".format(page + 1)))
