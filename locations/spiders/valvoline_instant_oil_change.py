...
class ValvolineInstantOilChangeSpider(scrapy.Spider):
    ...
    def parse(self, response):
        state_urls = response.xpath('//*[@class="map-list-item is-single"]/strong/a/@href').extract()
    ...
    def parse_cities(self, response):
        city_urls = response.xpath('//*[@class="map-list-item is-single"]/strong/a/@href').extract()
    ...
    def parse_stores(self, response):
        place_urls = response.xpath('//*[@class="location-name-wrap"]/a/@href').extract()
