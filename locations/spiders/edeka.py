...
HEADERS={'referer' : 'https://edeka.de/marktsuche.jsp',
...
class EdekaSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for store in store_data:
            ...
            try:
                properties['phone'] = store['telefon_tlc']
