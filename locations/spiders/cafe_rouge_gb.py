...
class CafeRougeGBSpider(Spider):
    name = "cafe_rouge_gb"
    item_attributes = {"brand": "Cafe Rouge", "brand_wikidata": "Q5017261"}
    ...
    def parse(self, response: Response, **kwargs: Any) -> Any:
        for location in response.json():
            ...
            item["website"] = urljoin("https://www.caferouge.com/restaurants/", location["slug"])
