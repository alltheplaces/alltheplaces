...
class RiversAUSpider(SitemapSpider):
    name = "rivers_au"
    item_attributes = {"brand": "Rivers", "brand_wikidata": "Q106224813"}
    allowed_domains = ["www.rivers.com.au"]
    sitemap_urls = ["https://www.rivers.com.au/Store.xml"]
