...
class ChoiceHotelsSpider(scrapy.Spider):
    ...
    def parse_hotel(self, response):
        ...
        brand = data["hotel"]["general"]["brandName"] + " " + data["hotel"]["general"]["productName"]
    ...
    def parse(self, response):
        urls = response.xpath('//h3[contains(text(), "Locations")]/following-sibling::div//h6/a/@href').extract()
