...
class AlabamaDepartmentOfTransportationUSSpider(JSONBlobSpider):
    ...
    item_attributes = {"operator": "Alabama Department of Transportation", "operator_wikidata": "Q872788", "state": "AL", "extras": Categories.SURVEILLANCE_CAMERA.value}
    allowed_domains = ["api.algotraffic.com"]
    start_urls = ["https://api.algotraffic.com/v3.0/Cameras"]
    requires_proxy = "US"

    def post_process_item(self, item: Feature, response: Response, feature: dict) -> Iterable[Feature]:
        item["name"] = " ".join([feature["location"]["displayRouteDesignator"], feature["location"]["displayCrossStreet"]])
