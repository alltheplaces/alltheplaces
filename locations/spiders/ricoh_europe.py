...
class RicohEuropeSpider(scrapy.Spider):
    ...
    def start_requests(self):
        countries = ['United Kingdom', 'France', 'Germany', 'Netherlands', 'Austria', 'Belgium', 'Czech Republic',
                     'Denmark', 'Luxembourg', 'Norway', 'Poland', 'Portugal', 'Russia', 'Slovakia', 'South Africa',
                     'Spain', 'Sweden', 'Switzerland', 'Turkey', 'Finland', 'Hungary', 'Ireland', 'Italy']
