...
class CaddysItSpider(JSONBlobSpider):
    ...
    start_urls = ["https://www.caddys.it/on/demandware.store/Sites-Caddys-Site/it_IT/Stores-FindStores?radius=2500&lat=25.56009518531322&long=6.903786000000025&selectedFilters="]
    ...
    def pre_process_data(self, location):
        ...
        if 'countryCode' in location: del location['countryCode']
        # stateCode is unuseful, mostly 'Italia' or empty
        if 'stateCode' in location: del location['stateCode']
