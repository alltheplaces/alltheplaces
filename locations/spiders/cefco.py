        ...
        for store in json.loads(map_data):
            yield GeojsonPointItem(
                ...
                extras={
                    ...
                    'fuel:HGV_diesel': store['truckstop'] == True or store['truckstop'] == '1',
                    'fuel:e85': store['e85'] == True or store['e85'] == '1',
                    'fuel:octane_87': store['regular'] == True or store['regular'] == '1',
                    'fuel:octane_89': store['midgrade'] == True or store['midgrade'] == '1',
                    'fuel:octane_93': store['premium'] == True or store['premium'] == '1',
                    'fuel:kerosene': store['kerosene'] == True or store['kerosene'] == '1',
