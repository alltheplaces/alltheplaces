    ...
    def parse(self, response):
        ...
        for location in locations:
            ...
            if " live" in location[0]['studioName'].lower():  # Skip Orangetheory Live virtual records
                continue
            if location[0]['studioLocation']['physicalAddress'] in ["*", "a"]:  # Skip placeholder records
                continue
            if location[0]['studioLocation']['longitude'] in ["1.00000000", "0.00000000"]:  # Skip test records
                continue
