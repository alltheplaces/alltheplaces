...
class KiaKRSpider(Spider):
    ...
    def parse(self, response):
        ...
        yield JsonRequest(url="https://kwpapi.kia.com/kr/ko/api/v1/experience/sales-network/branchs?limitDistance=30000&latitude=37.4643623227152&longitude=127.042663599215", headers={"Ccsp-Authorization": "Bearer", "X-SYSTEM-AUTHORIZATION": f"Bearer {auth_token}"}, callback=self.parse_locations)
