...
class FirstHawaiianBankSpider(SweetIQSpider):
    ...
    def parse_item(self, item, location):
        ...
        if "Branch" in location["properties"]["metaFilterServices"] and "ATM" not in location["properties"]["metaFilterServices"]:
            apply_category(Categories.BANK, item)
        # Branch with an ATM
        elif "Branch" in location["properties"]["metaFilterServices"] and "ATM" in location["properties"]["metaFilterServices"]:
            apply_category(Categories.BANK, item)
            apply_yes_no(Extras.ATM, item, True)
        # ATM only
        elif "Branch" not in location["properties"]["metaFilterServices"] and "ATM" in location["properties"]["metaFilterServices"]:
