    ...
    def parse(self, response, **kwargs):
        for store in response.json().get("data"):
            ...
            for i, oh in enumerate(ohs):
                ...
                print(oh, opening_hour, closing_hour)
            ...
            yield Feature(
                {
                    ...
                    "country": attributes.get("field_shop_address_city"),
