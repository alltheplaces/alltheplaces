...
class SevenElevenJPSpider(AreamarkerSpider):
    ...
    # Meanings from the map page's https://seven-eleven.areamarker.com/711map/data/serviceCol.json and sample data.
    fields = {
        "ref": "kyo_id",  # store id
    ...
    search_conditions = [
        ...
        {
            "field": "col_2",
            "value": datetime.now(ZoneInfo("Asia/Tokyo")).strftime("%Y%m%d%H"),
            "comparison_operator": "<=",
        },
        {
            "conditions": [
