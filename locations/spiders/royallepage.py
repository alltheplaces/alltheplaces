...
class RoyalLePageSpider(scrapy.Spider):
    ...
    def parse_location(self, response):
        map_url = response.xpath('//div[contains(@class, "map-container")]/a/@href').extract_first()
    ...
    def parse(self, response):
        ...
        next_page = response.xpath('//div[contains(@class, "paginator")]//li[@class="is-active"]/following-sibling::li//a/@href').extract_first()
        if next_page:
