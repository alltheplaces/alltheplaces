...
class NiagaraFallsCityCouncilDrainManholesCASpider(ArcGISFeatureServerSpider):
    name = "niagara_falls_city_council_drain_manholes_ca"
    ...
    service_id = "Niagara_Falls_Storm_Sewer_Maintenance_Holes"
    layer_id = "0"
