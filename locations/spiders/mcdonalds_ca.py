...
class McDonaldsCASpider(scrapy.Spider):
    name = "mcdonalds_ca"
    ...
    def start_requests(self):
        ...
        base_url = "https://www.mcdonalds.com/googleappsv2/geolocation?latitude={lat}&longitude={lng}&radius=100&maxResults=250&country=ca&language=en-ca"
    ...
    def parse(self, response):
        ...
        for store in data.get("features", []):
            ...
            if store_info["addressLine4"] == "Canada":
