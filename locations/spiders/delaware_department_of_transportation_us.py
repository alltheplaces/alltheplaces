...
class DelawareDepartmentOfTransportationUSSpider(JSONBlobSpider):
    ...
    item_attributes = {"operator": "Delaware Department of Transportation", "operator_wikidata": "Q3297972", "state": "DE", "extras": Categories.SURVEILLANCE_CAMERA.value}
    ...
    def post_process_item(self, item: Feature, response: Response, feature: dict) -> Iterable[Feature]:
        if not feature["enabled"] or feature["status"] != "Active":
            ...
            return
        item["extras"]["contact:webcam"] = ";".join(filter(None, [feature["urls"].get("rtmp"), feature["urls"].get("rtsp"), feature["urls"].get("m3u8s")]))
