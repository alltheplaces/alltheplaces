    ...
    def parse_location(self, response):
        ...
        properties = {
            ...
            "phone": response.xpath(
                '//span[@class="location-block__telephone--ie"]/text()'
            ).extract_first(),
            "name": response.xpath(
                '//h1[@class="banner-inner__title"]/text()'
            ).extract_first(),
            "country": "UK",
            "lat": float(
