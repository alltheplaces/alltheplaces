...
class ExpressSpider(scrapy.Spider):
    ...
    name = "express"
    allowed_domains = ["stores.express.com"]
    download_delay = 0.5
    start_urls = (
    ...
    def parse_stores(self, response):
        ...
        hours = response.xpath('//table[@class="c-location-hours-details"]/tbody/tr/@content').extract()
        if hours != []:
            hours = "; ".join(hours)
