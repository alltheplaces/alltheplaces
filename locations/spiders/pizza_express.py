    ...
    def parse(self, response):
        with open('./locations/searchable_points/eu_centroids_120km_radius_country.csv') as points:
            ...
            for point in points:
                ...
                country = row[3]
                if country == "UK":
                    searchurl = 'https://www.pizzaexpress.com/api/Restaurants/FindRestaurantsByLatLong?latitude={la}&longitude={lo}&searchTerm=246%20Bradford%20Street%2C%20Birmingham%2C%20UK&pageNumber=1&limit=2000'.format(la=lati, lo=long)
