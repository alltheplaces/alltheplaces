...
class SmatchBESpider(scrapy.Spider):
    name = "smatch_be"
    item_attributes = {"brand": "Smatch", "brand_wikidata": "Q5185959"}
    start_urls = ["https://www.supermarche-match.be/storelocator?query=&type%5B%5D=smatch"]
