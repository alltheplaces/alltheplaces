...
class AcmeMarketsSpider(scrapy.Spider):
    ...
    def parse_store(self, response):
        ...
        properties = {
            'ref': ref,
            'name': response.xpath('normalize-space(//div[@class="Heading--lead ContentBanner-title"]/text())').extract_first(),
            ...
            'country': 'US',
            'phone': response.xpath('normalize-space(//a[@class="Phone-link"]//text())').extract_first(),
