...
class Big4HolidayParksAUSpider(JSONBlobSpider):
    ...
    def start_requests(self) -> Iterable[Request]:
        ...
        yield Request(url=self.start_urls[0], method="POST", headers=headers, body='[{"key":"","value":""}]', callback=self.parse)
    ...
    def parse_contact_information(self, response: Response) -> Iterable[Feature]:
        ...
        properties["phone"] = response.xpath('//p[contains(@class, "SidebarInfoBlock_phone__")]/a[contains(@href, "tel:")]/@href').get("").replace("tel:", "")
