...
class Mitre10NZSpider(Spider):
    ...
    start_urls = ["https://ccapi.mitre10.co.nz/mitre10webservices/v2/mitre10/geolocation/store-locator?fields=FULL&page=0&pageSize=1000&storeCode=28&lang=en&curr=NZD"]
    ...
    def parse(self, response):
        for location in response.json()["stores"]:
            ...
            item["city"] = location["address"].get("suburb", location["address"].get("town", location["address"].get("city")))
