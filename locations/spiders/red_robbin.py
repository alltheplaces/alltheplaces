    ...
    def start_requests(self):
        with open('./locations/searchable_points/us_centroids_100mile_radius.csv') as points:
            ...
            for point in points:
                ...
                form_data = {"operationName": "RestaurantQueries",
                             "variables": {"latitude": float(lat), "longitude": float(lon), "radius": 200},
                ...
                yield scrapy.http.FormRequest(url="https://api.burgerblaster.io/graphql", method='POST',
    ...
    def parse(self, response):
        ...
        for place in results['data']['restaurants']['byGeolocation']:
            properties = {
                ...
                'website': "https://www.redrobin.com/locations" + place["restaurant"]["uri"]
            }

            hours = self.parse_hours(place["restaurant"]["serviceHours"]["restaurantHours"])
            if hours:
