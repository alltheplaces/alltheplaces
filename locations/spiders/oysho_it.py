...
class OyshoItSpider(scrapy.Spider):
    name = "oysho_it"
    item_attributes = {
        "brand": "Oysho",
    ...
    def start_requests(self):
        url = "https://www.oysho.com/itxrest/2/bam/store/64009605/physical-store?languageId=-4&appId=1&latitude={}&longitude={}&countryCode=IT&radioMax=5000"
        for lat, lon in point_locations("eu_centroids_120km_radius_country.csv", "IT"):
