...
class MaverikSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.Request('https://gateway.maverik.com/ac-loc/location/all',
                             callback=self.add_fuels)

    def add_fuels(self, response):
        yield scrapy.Request('https://gateway.maverik.com/ac-loc/location/fuel/all',
                             headers={'APP-ID': 'PAYX'},
    ...
    def parse(self, response):
        ...
        for location in locations:
            ...
            fuel = next(
                (f for f in fuels if f['storeCode'] == location['code']), None)
            ...
            yield GeojsonPointItem(
                ...
                phone=address['phone'],
                opening_hours='24/7' if '12:00AM - 12:00AM' == location.get(
                    'hoursOfOperation') else None,
                extras={
