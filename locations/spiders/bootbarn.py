...
class BootbarnSpider(scrapy.Spider):
    ...
    def parse_location(self, response):
        properties = {
            ...
            'postcode': response.xpath('normalize-space(//span[@class="store-address-postal-code"]//text())').extract_first(),
        ...
        properties['opening_hours'] = self.parse_hours(response.xpath('//div[@class="store-details-section"]//div[@class="store-hours-days"]/span/text()').extract())
