...
class FollettSpider(scrapy.Spider):
    ...
    def parse(self, response):
        store_urls = response.xpath(
            '//div[@class="block-store col-lg-4 col-md-4 col-sm-6 col-xs-12 widget-block"]/h4/a/@href').extract()
    ...
    def parse_store(self, response):
        ...
        properties = {
            ...
            'postcode': response.xpath(
                'normalize-space(//span[@itemprop="addressRegion"]/following-sibling::text())').extract_first(),
