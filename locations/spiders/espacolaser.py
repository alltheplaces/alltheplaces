...
class Espacolaser(JSONBlobSpider):
    name = "espacolaser"
    item_attributes = {
        "brand": "Espaçolaser",
        "brand_wikidata": "Q112326409",
    }
    start_urls = ["https://func-prd-ecom-svc-ecm-el.azurewebsites.net/api/espacolaser/pt-BR/GetEstablishments?lat=-34&lng=138&appChannel=ECM_SL_BRA&skip=0&code=0FRo43/d4a16aXUWaJIc0sTUK58L2jyZCat2VWG8P9IUEwguAmpzNw=="]
