        ...
        for store in stores:
            properties = {
                ...
                "street_address": store.xpath(
                    './div[@class="cl_rest_box"]/div[@class="clbox_street"]/text()'
                ).get(),
                "city": store.xpath(
                    './div[@class="cl_rest_box"]/div[@class="clbox_city"]/text()'
                ).get(),
                "postcode": store.xpath(
                    './div[@class="cl_rest_box"]/div[@class="clbox_zip"]/text()'
                ).get(),
                "country": store.xpath(
                    './div[@class="cl_rest_box"]/div[@class="clbox_country"]/text()'
                ).get(),
                "phone": store.xpath(
