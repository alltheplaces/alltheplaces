...
class ToymasterGBSpider(JSONBlobSpider):
    ...
    start_urls = ["https://api.toymaster.co.uk/stores?status=Active&storefinder=true&locale=en-GB&api_key=137601c9-ef9c-41e1-8f07-a4cde23f8c7c"]

    def post_process_item(self, item: Feature, response: Response, feature: dict) -> Iterable[Request]:
        item["street_address"] = merge_address_lines([feature.get("Address1"), feature.get("Address2"),feature.get("Address3"),feature.get("Address4")])
