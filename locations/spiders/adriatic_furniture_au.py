...
class AdriaticFurnitureAUSpider(CrawlSpider):
    ...
    rules = [Rule(LinkExtractor(restrict_text="VIEW TRADING HOURS", process_value=lambda x: x.replace("adriaticfurniture-au.myshopify.com", "www.adriatic.com.au")), follow=False, callback="parse")]
    ...
    def parse(self, response: Response) -> Iterable[Feature]:
        ...
        if ("VIC" in properties["addr_full"] or "Victoria" in properties["addr_full"]) and not properties["phone"].startswith("0"):
