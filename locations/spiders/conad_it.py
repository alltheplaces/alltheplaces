...
class ConadITSpider(Spider):
    ...
    brands = {
        ...
        "CONAD SELF 24h": {"brand": "Conad self 24h", "brand_wikidata": None, "extras": Categories.FUEL_STATION.value},
        "CONAD SUPERSTORE": {"brand": "Conad Superstore", "brand_wikidata": "Q118129616"},
        "MARGHERITA CONAD": {"brand": "Margherita Conad", "brand_wikidata": None},
        "MARKET CONAD": {"brand": "Market Conad", "brand_wikidata": None},
        "PARAFARMACIA CONAD": {
        ...
        "SAPORI & DINTORNI CONAD": {"brand": "Sapori & Dintorni Conad", "brand_wikidata": None},
