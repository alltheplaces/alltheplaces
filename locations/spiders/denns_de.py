...
class DennsDeSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.biomarkt.de/api/es/market/_search/?source=%7B%22from%22:0,%22size%22:1000,%22sort%22:[],%22query%22:%7B%22bool%22:%7B%22must%22:[]%7D%7D%7D&source_content_type=application%2Fjson']
    download_delay = 0.2
    ...
    def parse(self, response):
        ...
        for store in stores:
            ...
            hours = self.parse_hours(
                store['_source']['openingHoursMarket']
            )
            if hours:
