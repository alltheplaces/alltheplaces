...
class HairhouseAUSpider(Spider):
    ...
    start_urls = ["https://www.hairhouse.com.au/api/storeList?latitude=-23.12&longitude=132.13&distance=20000&top=1000&_data=routes%2F(%24lang)%2Fapi%2FstoreList"]
    ...
    def parse(self, response):
        for location in response.json():
            ...
            hours_string = " ".join([day_hours["day"] + ": " + day_hours["hours"] for day_hours in location["operatingHours"]])
