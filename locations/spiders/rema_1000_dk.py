...
class REMA1000DKSpider(Spider):
    name = "rema_1000_dk"
    item_attributes = {"brand": "REMA 1000", "brand_wikidata": "Q115768834", "extras": Categories.SHOP_SUPERMARKET.value}
    ...
    def parse(self, response):
        for location in response.json()["data"]:
            ...
            for day_hours in location.get("opening_hours", {}).values():
                hours_string = "{} {}: {} - {}".format(hours_string, day_hours.get("day"), day_hours.get("open"), day_hours.get("close"))
