...
class HallmarkSpider(scrapy.Spider):
    ...
    start_urls = ['https://maps.hallmark.com/api/getAsyncLocations?template=search&level=search&search=66952&radius=10000&limit=3000']
    ...
    def parse(self, response):
        ...
        for location in data:
            ...
            properties = {
                ...
                'street': location['address_1'] + " " + location['address_2'] if location['address_2'] else location['address_1'],
                'city': location['city'],
