...
class SaversSpider(SitemapSpider, StructuredDataSpider):
    ...
    sitemap_urls = ["https://stores.savers.com/sitemap/sitemap_index.xml", "https://stores.savers.com.au/sitemap/sitemap_index.xml"]
    sitemap_rules = [
        (
    ...
    def post_process_item(self, item, response, ld_data):
        ...
        item["brand"] = response.xpath('//@data-brand').get().replace("Savers AU", "Savers").replace("Boutique", "Savers")
        item.pop("image")
        item.pop("facebook")
