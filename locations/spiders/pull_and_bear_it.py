...
class PullAndBearSpiderIt(scrapy.Spider):
    name = "pull_and_bear_it"
    item_attributes = {
        "brand": "Pull&Bear",
    ...
    start_urls = [
        "https://www.pullandbear.com/itxrest/2/bam/store/24009404/physical-stores-by-country?countryCode=IT&appId=1"
    ]
