...
class EarthFareSpider(scrapy.Spider):
    ...
    def parse(self, response):
        stores = response.xpath('//script[@type="text/javascript" and contains(text(), "storeDetail")]/text()').extract_first()
        ...
        for store in store_data:
            ...
            properties = {
                ...
                'website': 'https://www.earthfare.com/rs/StoreLocator?id={0}'.format(store_details["CS_StoreID"]),
