...
class KentuckyTransportationCabinetUSSpider(JSONBlobSpider):
    ...
    item_attributes = {
        ...
        "operator_wikidata": "Q4926022",
        "state": "KY",
        "extras": Categories.SURVEILLANCE_CAMERA.value,
    }
    allowed_domains = ["services2.arcgis.com"]
    start_urls = [
        "https://services2.arcgis.com/CcI36Pduqd0OR4W9/ArcGIS/rest/services/trafficCamerasCur_Prd/FeatureServer/0/query?where=1%3D1&outFields=OBJECTID%2Cdescription%2Csnapshot%2Clatitude%2Clongitude&f=pjson"
    ]
