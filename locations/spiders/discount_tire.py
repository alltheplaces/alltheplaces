...
class DiscountTireSpider(scrapy.Spider):
    ...
    def parse_site(self, response):
        ...
        for url in urls:
            ...
            payload = {"operationName": "StoreByCode", "variables": {"storeCode": f"{store_code}"},
            ...
            yield scrapy.Request(url=URL, method='POST', body=json.dumps(payload), callback=self.parse_stores,
                                 meta={'website': url})
