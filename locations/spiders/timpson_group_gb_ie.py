...
class TimpsonGroupGBIESpider(JSONBlobSpider):
    ...
    brands = {
        "johnsons": {"brand": "Johnsons", "brand_wikidata": "Q6268527", "category": Categories.SHOP_DRY_CLEANING, "website_template": "https://www.johnsoncleaners.com/branch/{}"},
        "maxphoto": {"brand": "Max Spielmann", "brand_wikidata": "Q76221051", "category": Categories.SHOP_PHOTO, "website_template": "https://www.maxphoto.co.uk/photo-store-locator/{}"},
        "snappysnaps": {"brand": "Snappy Snaps", "brand_wikidata": "Q7547351", "category": Categories.SHOP_PHOTO, "website_template": "https://www.snappysnaps.co.uk/{}/more-times"},
        "timpson": {"brand": "Timspon", "brand_wikidata": "Q7807658", "category": Categories.SHOP_LOCKSMITH, "website_template": "https://www.timpson.co.uk/stores/{}"},
    }
    ...
    def post_process_item(self, item: Feature, response: Response, feature: dict) -> Iterable[Feature]:
        ...
        if feature.get("supermarket") and feature["supermarket"] != "0":
            match feature["supermarket"]:
                ...
                case _:
                    self.logger.error("Unknown supermarket within which this feature is located: {}".format(feature["supermarket"]))
                    return
