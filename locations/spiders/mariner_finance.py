...
class MarinerFinanceSpider(scrapy.Spider):
    ...
    allowed_domains = ['www.marinerfinance.com',
    ...
    def parse_store(self, response):
        ...
        yield scrapy.Request(url='https://loans.marinerfinance.com/getResults', method='POST',
                             body=json.dumps({"zipcode": f"{zipcode}"}), headers=headers, meta=meta,
