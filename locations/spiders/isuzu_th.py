...
from locations.hours import OpeningHours, CLOSED_TH
...
class IsuzuTHSpider(JSONBlobSpider):
    ...
    def post_process_item(self, item: Feature, response: Response, feature: dict) -> Iterable[Feature]:
        ...
        if feature.get("sale"):
            ...
            hours_text = "Mon-Fri: {}, Sat: {}, Sun: {}".format(feature["sale"].get("showroom_hour_mon_fri", ""), feature["sale"].get("showroom_hour_sat", ""), feature["sale"].get("showroom_hour_sun", ""))
        ...
        if feature.get("aftersale"):
            ...
            hours_text = "Mon-Fri: {}, Sat: {}, Sun: {}".format(feature["aftersale"].get("service_center_hour_mon_fri", ""), feature["aftersale"].get("service_center_hour_sat", ""), feature["aftersale"].get("service_center_hour_sun", ""))
