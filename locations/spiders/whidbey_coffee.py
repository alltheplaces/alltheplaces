...
from locations.hours import DAYS_3_LETTERS_SUNDAY, OpeningHours
    ...
    def parse_hours(self, hours):
        ...
        for hour in hours:
            ...
            if "-" in day_range:
                ...
                for day in DAYS_3_LETTERS_SUNDAY[
                    DAYS_3_LETTERS_SUNDAY.index(start_day[0:3]) : DAYS_3_LETTERS_SUNDAY.index(end_day[0:3]) + 1
                ]:
