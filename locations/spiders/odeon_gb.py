...
class OdeonGBSpider(JSONBlobSpider, CamoufoxSpider):
    ...
    start_urls = ["https://www.odeon.co.uk/api/omnia/v1/pageList?friendly=/cinemas/&properties=vistaCinema&properties=addressLine1&properties=addressLine2&properties=addressLine3&properties=latitude&properties=longitude&properties=postCode&properties=foodAndBeverageEnabled"]
    ...
    def post_process_item(self, item: Feature, response: Response, feature: dict) -> Iterable[Feature]:
        ...
        item["addr_full"] = merge_address_lines([feature.get("addressLine1"), feature.get("addressLine2"), feature.get("addressLine3"), feature.get("addressLine4")])
