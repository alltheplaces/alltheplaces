...
class HugoBossSpider(scrapy.Spider):
    ...
    def parse(self, response):
      ...
      if "data" in data:
            ...
            if "store_hours" in store:
                ...
                for key , value in open_hours.items():
                  if isinstance(value[0], str):
                    ...
                    clean_hours = clean_hours + day_formats[key] + ' ' + value[0][0] + '-' + value[0][1] + '; '
        ...
        yield  scrapy.Request(response.urljoin(self.start_urls[0]+'&start='+str(self.count)), callback=self.parse)
