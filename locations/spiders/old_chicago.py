...
class OldChicagoSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for loc in stores:
            ...
            hours = ', '.join([ '%s %s' % (h['days'], h['hours']) for h in node['simpleHours'] ])
