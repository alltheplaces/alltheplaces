...
class TimHortonsSpider(Spider):
    ...
    def start_requests(self):
        ...
        data = {"query": graphql_query, "variables": {"filter":{"status":"Open","environment":"prod"},"limit":10000}}
    ...
    def parse(self, response):
        ...
        for location in locations:
            ...
            for day in ["mon", "tue", "wed", "thu", "fri", "sat", "sun"]:
                if not location["diningRoomHours"].get(f"{day}Open") or not location["diningRoomHours"].get(f"{day}Close"):
                    continue
