...
class CompleatAnglerCampingWorldAUSpider(StockInStoreSpider):
    ...
    brands = {
        "COMPLEATANGLER": {"brand": "Compleat Angler", "brand_wikidata": "Q124062620", "extras": Categories.SHOP_FISHING.value},
        "CAMPINGWORLD": {"brand": "Camping World", "brand_wikidata": "Q124062618", "extras": Categories.SHOP_OUTDOOR.value},
        "COMPLEATANGLERCAMPINGWORLD": {"brand": "Compleat Angler & Camping World", "brand_wikidata": "Q124062620", "extras": Categories.SHOP_OUTDOOR.value},
    }
    api_site_id = "10126"
    api_widget_id = "133"
    ...
    def parse_item(self, item, location):
        ...
        if "COMPLEAT ANGLER" in item["name"].upper() and ("CAMPING WORLD" in item["name"].upper() or "CAMPING OUTDOORS" in item["name"].upper()):
