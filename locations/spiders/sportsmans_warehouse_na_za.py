...
class SportsmansWarehouseNAZASpider(JSONBlobSpider):
    name = "sportsmans_warehouse_na_za"
    item_attributes = {
        "brand": "Sportsmans Warehouse",
        "brand_wikidata": "Q130485344",
    }
    start_urls = ["https://www.sportsmanswarehouse.co.za/store-locator/"]
    ...
    def post_process_item(self, item, response, location):
        ...
        item["website"] = f"https://www.sportsmanswarehouse.co.za/store/{location['slug']}"
