...
# Landry's Seafood uses a BentoBox store locator, which passes every location
# to a storeLocatorConfig() call on the locator page as a JavaScript object
# literal.
#
...
class LandrysSeafoodUSSpider(Spider):
    name = "landrys_seafood_us"
    item_attributes = {"brand": "Landry's Seafood", "brand_wikidata": "Q17016187"}
    allowed_domains = ["www.landrysseafoodhouse.com"]
    start_urls = ["https://www.landrysseafoodhouse.com/store-locator/"]
