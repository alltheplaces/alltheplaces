...
class AldiSudSISpider(scrapy.Spider):
    name = "aldi_sud_si"
    ...
    def parse(self, response):
        ...
        for child in self.children(container):
            yield scrapy.Request(
                "https://www.yellowmap.de/Presentation/AldiSued/sl-SI/ResultList?LocX={}&LocY={}&ZoomLevel={}".format(
    ...
    def hours(self, data):
        ...
        for day_group in data:
            ...
            if "-" in day:
                ...
                day = "{}-{}".format(WEEKDAYS[f_day], WEEKDAYS[t_day])
            else:
                day = WEEKDAYS[day[:2]]
            if hours == "zaprto":
