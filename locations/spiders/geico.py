...
class GeicoSpider(scrapy.Spider):
    ...
    start_urls = (
        'https://www.geico.com/sitemap.xml',
    )
    download_delay = 1.5
    ...
    def parse_location(self, response):
        ...
        if script_data:
            ...
            address = " ".join([data["address"]["streetAddress"],
            ...
            yield scrapy.http.FormRequest(url=MAP_URL, method='POST', formdata=form_data, meta=metadata,
