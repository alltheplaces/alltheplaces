...
class RabbaCASpider(Spider):
    ...
    start_urls = ["https://core.service.elfsight.com/p/boot/?page=https://rabba.com/locations/&w=3df8be4a-1f05-46f7-86b4-f9dd7e4f717a"]
    ...
    def parse(self, response):
        for location in response.json()["data"]["widgets"]["3df8be4a-1f05-46f7-86b4-f9dd7e4f717a"]["data"]["settings"]["markers"]:
