...
class LaHalleFRSpider(Spider):
    ...
    start_urls = ["https://www.lahalle.com/on/demandware.store/Sites-LHA_FR_SFRA-Site/fr_FR/Stores-FindStores?showMap=true&lat=48.85349504454055&long=2.3483914659676657&radius=10000"]
