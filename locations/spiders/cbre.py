...
class CBRE(scrapy.Spider):
    ...
    start_urls = (
        'https://www.cbre.us/people-and-offices',
    )
        ...
        try:
            ...
            for item in storere:
                ...
                properties = {
                    ...
                    'country': 'US',
                    'phone': response.xpath('//div[@class="numbers-wrapper__numbers numbers-wrapper__numbers--office tel"]//text()').extract_first().replace('+', ''),
