...
class FrasersGBSpider(JSONBlobSpider):
    ...
    def start_requests(self):
        ...
        formdata = {"query":"query getStoresByLocation($countryCode: String!, $distanceUnit: DistanceUnit!, $latitude: String!, $longitude: String!, $maxDistance: Int!, $storeKey: String!) {\n getStoresByLocation(\n countryCode: $countryCode\n distanceUnit: $distanceUnit\n latitude: $latitude\n longitude: $longitude\n maxDistance: $maxDistance\n storeKey: $storeKey\n ) {\n ...store\n }\n}\n\nfragment store on Store {\n accessibility {\n ...storeAccessibility\n }\n address {\n ...storeAddress\n }\n code\n concessions {\n ...storeConcession\n }\n description\n distance\n distanceUnit\n googleMapsImage\n googleMapsLink\n latitude\n longitude\n name\n openingHours {\n ...storeOpeningHours\n }\n phoneNumber\n services {\n ...storeService\n }\n slug\n storeType\n}\n\nfragment storeAccessibility on StoreAccessibility {\n description\n iconUrl\n}\n\nfragment storeAddress on StoreAddress {\n country\n countryCode\n postCode\n town\n address\n}\n\nfragment storeConcession on StoreConcession {\n title\n iconUrl\n}\n\nfragment storeOpeningHours on StoreOpeningHours {\n day\n openingTime\n closingTime\n}\n\nfragment storeService on StoreService {\n title\n description\n}","variables":{"countryCode":"GB","distanceUnit":"Miles","latitude":"53.880548243856985","longitude":"-1.8156785746075244","maxDistance":500,"storeKey":"HOF"}}
