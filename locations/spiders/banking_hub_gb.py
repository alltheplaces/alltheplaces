...
class BankingHubGBSpider(CrawlSpider):
    name = "banking_hub_gb"
    item_attributes = {"brand": "Banking Hub", "brand_wikidata": "Q131824197",
                       "operator": "Post Office", "operator_wikidata": "Q1783168" }
    ...
    def parse(self, response: Response, **kwargs: Any) -> Any:
        ...
        item["addr_full"] = merge_address_lines(response.xpath("//div[@class='banking-hub-details__address']/a//text()").getall())
