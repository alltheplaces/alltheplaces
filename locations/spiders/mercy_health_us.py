...
HEALTHCARE_CATEGORIES = {
    ...
    "General Surgery": (Categories.HOSPITAL, [HealthcareSpecialities.SURGERY]),
    ...
    "Imaging and Radiology": (Categories.MEDICAL_IMAGING, [HealthcareSpecialities.DIAGNOSTIC_RADIOLOGY]),
