...
class NinetyNineRanchMarketUSSpider(Spider):
    ...
    item_attributes = {"brand": "99 Ranch Market", "brand_wikidata": "Q4646307", "extras": Categories.SHOP_SUPERMARKET.value}
    ...
    def parse(self, response):
        for location in response.json()["data"]["records"]:
            ...
            for day_hours in location.get("offlineBusinessTimes", []):
                hours_string = "{} {}: {} - {}".format(hours_string, day_hours["dayOfWeeks"], day_hours["startTime"], day_hours["endTime"])
