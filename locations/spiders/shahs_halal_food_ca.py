...
class ShahsHalalFoodCASpider(Spider):
    ...
    def parse(self, response: Response) -> Iterable[Feature]:
        for feature in response.xpath('//div[contains(@class, "location-box")]/ul/li'):
            properties = {
                "addr_full": merge_address_lines(feature.xpath('(.//h4[text()="Address"]/following-sibling::p)[1]/text()').getall()),
            ...
            hours_text = " ".join(feature.xpath('(.//h6[text()="RESTAURANT HOURS"]/following-sibling::p)[1]/text()').getall())
