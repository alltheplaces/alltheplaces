...
class McDonaldsPTSpider(scrapy.Spider):
    ...
    start_urls = (
        'https://en.wikipedia.org/wiki/List_of_postal_codes_in_Portugal',
    )
    ...
    def parse(self, response):
        ...
        for postalCode in postalCodes:
            ...
            yield scrapy.Request('https://www.mcdonalds.pt/web-api/Proxy/Restaurants?termo=' + postalCode, callback=self.parse_store)
