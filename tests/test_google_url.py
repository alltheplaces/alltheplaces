...
def test_staticmap():
    ...
    assert url_to_coords(
        "https://maps.googleapis.com/maps/api/staticmap?center=49.183888,-2.10398&zoom=13&size=640x200&scale=2&markers=anchor:28,48|icon:https://assets.grandvision.io/global/store2.png|scale:2%7C49.183888,-2.10398&mapType=roadmap&key=AIzaSyDYHg22qovy8ub0tMD8I1XCPxU3tHgNPJ4"
    ) == (49.183888, -2.10398)
