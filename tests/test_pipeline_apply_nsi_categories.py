...
def get_test_objects(
    ...
    operator_wikidata: str | None = None,
    country: str | None = None,
    state: str | None = None,
    categories: list[dict] | None = None,
) -> (Feature, ApplyNSICategoriesPipeline, Spider):
...
def test_brand_country_missing():
    ...
    # country.
    item, pipeline, spider = get_test_objects(
        spider_name="woolworths_au",
        brand_wikidata="Q3249145",
        state="NSW",
...
def test_brand_country_invalid():
    ...
    item, pipeline, spider = get_test_objects(
        spider_name="harolds_chicken_shack_gb",
        brand_wikidata="Q5659832",
        country="GB",
        categories=[Categories.FAST_FOOD.value],
    )
    pipeline.process_item(item, spider)
...
def test_brand_state_missing():
    ...
    item, pipeline, spider = get_test_objects(
        spider_name="first_national_bank_texas_us",
        brand_wikidata="Q110622177",
        country="US",
    ...
    item, pipeline, spider = get_test_objects(
        spider_name="harolds_chicken_shack_us",
        brand_wikidata="Q5659832",
        country="US",
        categories=[Categories.FAST_FOOD.value],
    )
