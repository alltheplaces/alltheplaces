...
ALLOWED_UPPERCASE_COMPONENTS = {
    "AU", "AT", "BE", "BG", "CA", "CZ", "CH", "DE", "DK", "ES", "FR", "GB", "HU", "IE", "IN", "IT", "KE",
    "KW", "KR", "KZ", "MT", "MX", "NL", "NO", "NZ", "PL", "PT", "RO", "RS", "RU", "SE", "TR", "TW", "US", "UK", "ZA",
}
        ...
        if isinstance(node, ast.ClassDef):
            ...
            if spider_name:
                ...
                if class_name != expected_class_name:
                    errors.append(f"Spider name '{spider_name}' should use class name '{expected_class_name}' instead "
                                  f"of '{class_name}'")

                if file_name != expected_file_name:
                    errors.append(f"Class name '{class_name}' should use file name '{expected_file_name}.py' instead "
                                  f"of '{file_name}.py'")
